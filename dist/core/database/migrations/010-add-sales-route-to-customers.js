...
module.exports = {
    up: (queryInterface, Sequelize) => __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.addColumn('customers', 'sales_route_id', {
        ...
        yield queryInterface.addIndex('customers', ['sales_route_id']);
    }),
    down: (queryInterface, Sequelize) => __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.removeColumn('customers', 'sales_route_id');
    })
};
