    ...
    function getRoutes(stack, parentPath = '', parentModule = '', parentHasAuth = false, parentRouter = null) {
        stack.forEach(layer => {
            ...
            if (layer.route && layer.route.path) {
                ...
                const moduleName = ((_a = layer.handle) === null || _a === void 0 ? void 0 : _a.moduleName) || parentModule || fullPath.split('/')[1] || 'General';
                ...
                const routeFields = layer.route.stack
                    .map(l => { var _a; return (_a = l.handle) === null || _a === void 0 ? void 0 : _a.fields; })
                    .filter(Boolean)[0];
                // Try to find route metadata from parent router's routesMeta
                let routeMeta = null;
                if (parentRouter && parentRouter.routesMeta) {
                    routeMeta = parentRouter.routesMeta.find(meta => meta.path === layer.route.path &&
                ...
                routesByModule[moduleName].push({
                    ...
                    description: (routeMeta === null || routeMeta === void 0 ? void 0 : routeMeta.description) || null,
                    sampleRequest: (routeMeta === null || routeMeta === void 0 ? void 0 : routeMeta.sampleRequest) || null,
                    sampleResponse: (routeMeta === null || routeMeta === void 0 ? void 0 : routeMeta.sampleResponse) || null,
                    queryParams: (routeMeta === null || routeMeta === void 0 ? void 0 : routeMeta.queryParams) || null,
                    database: (routeMeta === null || routeMeta === void 0 ? void 0 : routeMeta.database) || null,
                });
            }
                ...
                const moduleName = ((_b = layer.handle) === null || _b === void 0 ? void 0 : _b.moduleName) || parentModule || '';
                // Check if this router has verifyToken middleware
                const routerHasAuth = layer.handle.stack.some(l => l.name === 'verifyToken' || l.name === 'auth' ||
