...
router.routesMeta = [
    ...
    },
    {
        ...
        database: {
            ...
            optionalFields: ['password', 'phone', 'position', 'department_id', 'hire_date', 'salary', 'address', 'city', 'status', 'thumb_url', 'gallery_items'],
    ...
    },
    {
        ...
        database: {
            tables: ['users'],
            mainTable: 'users',
            updatableFields: ['first_name', 'last_name', 'email', 'password', 'phone', 'position', 'department_id', 'salary', 'address', 'city', 'status', 'thumb_url', 'gallery_items'],
