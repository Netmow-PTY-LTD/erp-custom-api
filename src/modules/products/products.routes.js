...
router.routesMeta = [
    {
        ...
        database: {
            ...
            mainTable: 'products',
            fields: {
                products: ['id', 'name', 'sku', 'description', 'category_id', 'unit_id', 'price', 'cost', 'stock_quantity', 'initial_stock', 'min_stock_level', 'max_stock_level', 'barcode', 'image_url', 'is_active', 'created_at', 'updated_at'],
                categories: ['id', 'name'],
    ...
    },
    {
        ...
        database: {
            ...
            optionalFields: ['description', 'cost', 'stock_quantity', 'initial_stock', 'min_stock_level', 'max_stock_level', 'barcode', 'image_url', 'weight', 'length', 'width', 'height', 'is_active'],
